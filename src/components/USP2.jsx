        ...
        <div className='flex-none h-full'>
         ...
         <div className='absolute top-0 w-full flex h-full md:clip-arrow bg-green-600/40 md:bg-green-600 py-6'>
              <div className='flex-1 pl-6 md:pl-10 lg:pl-20 flex flex-col justify-center'>
                  ...
                  <p className='pl-2 text-sm md:text-lg fornt-normal text-neutral-100 leading-8 md:leading-10'>In large quantities, Fresh, dry, name it;  <br /> <span className=' md:bg-[#D1954c] text-white md:px-2 py-1 rounded'>We Supply</span>   in 3 simple steps! 
                  <span className=' md:bg-[#D1954c] text-white md:px-2 md:py-1 rounded md:ml-2 block sm:inline w-max h-max'>Start ordering now ...</span></p>
              </div>
